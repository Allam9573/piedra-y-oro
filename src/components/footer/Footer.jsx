...
export const Footer = () => {
    ...
    return (
        <>
            <footer class="footer-desktop" style={{ backgroundColor: '#343A36' }} id="tempaltemo_footer">
                <div class="container">
            ...
            <footer className='footer-mobile'>
                <div class="mx-3 pt-5">
                    ...
                    <ul class="list-unstyled text-light mt-3 py-3 footer-link-list">
                        ...
                        <li>
                            <i class="fa fa-phone fa-fw"></i>
                            <a class="text-decoration-none text-white" href="https://wa.me/+50494969595">Tel: +504 9496-9595</a>
                        </li>
                        <li>
                            <i class="fa fa-envelope fa-fw"></i>
                            <a class="text-decoration-none py-4 text-white" href="mailto:lionettashn@gmail.com">lionettashn@gmail.com</a>
                        </li>
                    </ul>
                </div>
                <div>
